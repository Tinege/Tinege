...
// Copyright (c) 2013 Tinege developers
...
const string strMessageMagic = "Tinege Signed Message:\n";
...
static const int64 nStartSubsidy = 16099 * COIN;
static const int64 nMinSubsidy = 1 * COIN;
static const int64 mDoublePeriod = 90 * 24 * 60 * 2;
static const int64 yDoublePeriod = 365 * 24 * 60 * 2;

int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = nStartSubsidy;

	if(nHeight > 0 && nHeight <= 10) {nSubsidy = 1050000000000 * COIN;} 
	else if(nHeight < mDoublePeriod * 1) {nSubsidy = 1000 * COIN;} 
	else if(nHeight < mDoublePeriod * 2) {nSubsidy = 5000 * COIN;}
	else if(nHeight < mDoublePeriod * 3) {nSubsidy = 10000 * COIN;}
	else if(nHeight < mDoublePeriod * 4) {nSubsidy = 100000 * COIN;}
	
	else if(nHeight < yDoublePeriod * 2) {nSubsidy = 150000 * COIN;}
	else if(nHeight < yDoublePeriod * 3) {nSubsidy = 200000 * COIN;}
	else if(nHeight < yDoublePeriod * 4) {nSubsidy = 250000 * COIN;}
	else if(nHeight < yDoublePeriod * 5) {nSubsidy = 300000 * COIN;}
	else if(nHeight < yDoublePeriod * 6) {nSubsidy = 350000 * COIN;}
	else if(nHeight < yDoublePeriod * 7) {nSubsidy = 400000 * COIN;}
	else if(nHeight < yDoublePeriod * 8) {nSubsidy = 450000 * COIN;}
	else if(nHeight < yDoublePeriod * 9) {nSubsidy = 500000 * COIN;}
	else if(nHeight < yDoublePeriod * 10) {nSubsidy = 550000 * COIN;}
	else if(nHeight < yDoublePeriod * 11) {nSubsidy = 600000 * COIN;}
	else if(nHeight < yDoublePeriod * 12) {nSubsidy = 660000 * COIN;}
	else if(nHeight < yDoublePeriod * 13) {nSubsidy = 700000 * COIN;}
	else if(nHeight < yDoublePeriod * 14) {nSubsidy = 750000 * COIN;}
	else if(nHeight < yDoublePeriod * 15) {nSubsidy = 780000 * COIN;}
	else if(nHeight < yDoublePeriod * 16) {nSubsidy = 800000 * COIN;}
	else if(nHeight < yDoublePeriod * 17) {nSubsidy = 900000 * COIN;}
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 150; // 2.5 minutes
static const int64 nTargetSpacing = 30; // 30 seconds
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 5 blocks

static const int64 nAveragingInterval = nInterval * 20; // 100 blocks
static const int64 nAveragingTargetTimespan = nAveragingInterval * nTargetSpacing; // 3000 seconds -- 50 minutes
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TinegeMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TinegeMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running TinegeMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
